...
namespace ShipmentTracking
{
    public class Startup
    {
        public Startup(IConfiguration configuration)
        {
            ...
            Program.ConnectionString = Configuration.GetConnectionString("MSSQL");
            sql.ConnectionString = Program.ConnectionString;
            try
            {
                sql.Open();
            }catch (Exception) {
                Console.WriteLine("Connect to MSSQL faild.");
                Program.ConnectionString = Configuration.GetConnectionString("MSSQL-Default");
            }
            finally
            {
                sql.Close();
